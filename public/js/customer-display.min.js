...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=script&lang=js"
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    var screenId = params && params.get('screen') || '1';
    return {
      screenId: screenId,
    ...
    subtotal: function subtotal() {
      try {
        return (this.items || []).reduce(function (sum, it) {
          return sum + Number(it && it.subtotal || 0);
        }, 0);
      } catch (e) {
        return 0;
      }
  ...
  methods: {
    format: function format(n) {
      var num = Number(n || 0);
      var locale = this.$i18n && this.$i18n.locale || navigator.language || 'en-US';
      try {
    ...
    applyCart: function applyCart(cart) {
      if (!cart) {
        this.items = [];
        this.discount = 0;
        this.tax = 0;
        this.total = 0;
        this.currency = cart && cart.currency || '';
        return;
      }
      this.currency = cart.currency || '';
      this.items = (cart.details || cart.items || []).map(function (it) {
        var qty = Number(it.quantity || it.Qty || it.qte || 0);
        var unit = Number(it.unit_price || it.Net_price || it.price || 0);
        var line = Number(it.line_total || it.subtotal || it.total || 0);
        var subtotal = line > 0 ? line : unit * qty;
        return {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _context.p = 0;
              _context.n = 1;
              return axios.get('pos/customer-display/last-cart', {
                params: {
                  screen: _this.screenId
                }
              });
            case 1:
              _yield$axios$get = _context.v;
              data = _yield$axios$get.data;
              if (data && data.cart) _this.applyCart(data.cart);
              if (data && data.completed) {
                _this.items = [];
                _this.footerMessage = _this.$t('Sale_Completed_Thank_You');
              }
              _context.n = 3;
              break;
            case 2:
    ...
    setupRealtime: function setupRealtime() {
      var _this2 = this;
      var channelName = 'pos-cart.' + this.screenId;
      if (window.Echo && window.Pusher) {
        try {
          window.Echo.channel(channelName).listen('.CartUpdated', function (e) {
            if (e && e.cart) _this2.applyCart(e.cart);
            if (e && e.completed) {
              _this2.items = [];
              _this2.footerMessage = _this2.$t('Sale_Completed_Thank_You');
            }
          }).listenForWhisper('cart-updated', function (cart) {
            _this2.applyCart(cart);
          }).listenForWhisper('sale-completed', function () {
            _this2.items = [];
            _this2.footerMessage = _this2.$t('Sale_Completed_Thank_You');
          });
          return true;
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ok = _this3.setupRealtime();
            if (!ok) {
              _this3.poll();
              _this3.pollTimer = setInterval(_this3.poll, 2500);
            }
          case 1:
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true"
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c('div', {
    ...
    attrs: {
      "src": _vm.logo,
      "alt": _vm.$t('Store_Logo')
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "store-info"
  }, [_c('h1', {
    staticClass: "store-name"
  }, [_vm._v(_vm._s(_vm.$t('Welcome')))]), _vm._v(" "), _c('p', {
    staticClass: "tagline"
  }, [_vm._v(_vm._s(_vm.$t('Thank_you_for_shopping_with_us')))])]), _vm._v(" "), _c('div', {
    staticClass: "payable-summary"
  }, [_c('div', {
    staticClass: "payable-label"
  }, [_vm._v(_vm._s(_vm.$t('Total_Payable')))]), _vm._v(" "), _c('div', {
    staticClass: "payable-value"
  }, [_vm._v(_vm._s(_vm.currency) + " " + _vm._s(_vm.format(_vm.total)))])])]), _vm._v(" "), _c('div', {
    staticClass: "cd-content"
  }, [_c('div', {
    staticClass: "cd-scroll"
  }, [!_vm.hasItems ? _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Waiting_for_Items')))]), _vm._v(" "), _c('p', {
    staticClass: "empty-subtitle"
  }, [_vm._v(_vm._s(_vm.$t('Items_will_appear_here_as_added_to_cart')))])]) : _c('div', {
    staticClass: "cd-list"
  }, _vm._l(_vm.items, function (row, idx) {
    return _c('div', {
      key: idx,
      staticClass: "cd-item",
      style: {
        animationDelay: "".concat(idx * 0.05, "s")
      }
    }, [_c('div', {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Quantity')) + ": "), _c('strong', [_vm._v(_vm._s(row.quantity))])])])]), _vm._v(" "), _c('div', {
      staticClass: "item-price"
    }, [_c('span', {
      staticClass: "price-value"
    }, [_vm._v(_vm._s(_vm.currency) + " " + _vm._s(_vm.format(row.subtotal)))])])]);
  }), 0)]), _vm._v(" "), _vm.hasItems ? _c('div', {
    staticClass: "cd-summary"
  }, [_c('div', {
    ...
    staticClass: "icon-subtotal"
  }, [_vm._v("🧮")]), _vm._v(" " + _vm._s(_vm.$t('Subtotal')) + "\n          ")]), _vm._v(" "), _c('span', {
    staticClass: "summary-value"
  }, [_vm._v(_vm._s(_vm.currency) + " " + _vm._s(_vm.format(_vm.subtotal)))])]), _vm._v(" "), _c('div', {
    staticClass: "summary-row"
  }, [_c('span', {
    staticClass: "summary-label"
  }, [_c('i', {
    staticClass: "icon-tax"
  }, [_vm._v("🧾")]), _vm._v(" " + _vm._s(_vm.$t('Tax')) + "\n          ")]), _vm._v(" "), _c('span', {
    staticClass: "summary-value"
  }, [_vm._v(_vm._s(_vm.currency) + " " + _vm._s(_vm.format(_vm.tax)))])]), _vm._v(" "), _c('div', {
    staticClass: "summary-row"
  }, [_c('span', {
    staticClass: "summary-label"
  }, [_c('i', {
    staticClass: "icon-discount"
  }, [_vm._v("🎁")]), _vm._v(" " + _vm._s(_vm.$t('Discount')) + "\n          ")]), _vm._v(" "), _c('span', {
    staticClass: "summary-value discount"
  }, [_vm._v("-" + _vm._s(_vm.currency) + " " + _vm._s(_vm.format(_vm.discount)))])]), _vm._v(" "), _c('div', {
    staticClass: "summary-row"
  }, [_c('span', {
    staticClass: "summary-label"
  }, [_c('i', {
    staticClass: "icon-shipping"
  }, [_vm._v("🚚")]), _vm._v(" " + _vm._s(_vm.$t('Shipping')) + "\n          ")]), _vm._v(" "), _c('span', {
    staticClass: "summary-value"
  }, [_vm._v(_vm._s(_vm.currency) + " " + _vm._s(_vm.format(_vm.shipping)))])]), _vm._v(" "), _c('div', {
    staticClass: "divider"
  }), _vm._v(" "), _c('div', {
    staticClass: "summary-row total-row"
  }, [_c('span', {
    staticClass: "summary-label total-label"
  }, [_c('i', {
    staticClass: "icon-total"
  }, [_vm._v("💰")]), _vm._v(" " + _vm._s(_vm.$t('Total')) + "\n          ")]), _vm._v(" "), _c('span', {
    staticClass: "summary-value total-value"
  }, [_vm._v(_vm._s(_vm.currency) + " " + _vm._s(_vm.format(_vm.total)))])])])]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "cd-footer"
  }, [_c('p', {
    staticClass: "footer-message"
  }, [_vm._v(_vm._s(_vm.footerMessage))]), _vm._v(" "), _vm.hasItems ? _c('div', {
...
/***/ "./resources/src/plugins/i18n.loader.js"
/*!**********************************************!*\
  !*** ./resources/src/plugins/i18n.loader.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   loadI18n: () => (/* binding */ loadI18n)
/* harmony export */ });
...
var loadI18n = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var userLang, dbMessages, isBaseURLSet, endpoint, response, messages, i18n, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          dbMessages = {};
          _context.p = 1;
          isBaseURLSet = axios__WEBPACK_IMPORTED_MODULE_2__["default"].defaults.baseURL && axios__WEBPACK_IMPORTED_MODULE_2__["default"].defaults.baseURL !== '/';
          endpoint = isBaseURLSet ? "translations/".concat(userLang) // baseURL will apply
          : "/api/translations/".concat(userLang); // full path for unauthenticated pages
          _context.n = 2;
          return axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(endpoint);
        case 2:
          response = _context.v;
        ...
        case 4:
          messages = _defineProperty({}, userLang, dbMessages || {});
          i18n = new vue_i18n__WEBPACK_IMPORTED_MODULE_1__["default"]({
            locale: userLang,
            fallbackLocale: 'en',
            messages: messages,
            silentTranslationWarn: true
          });
          return _context.a(2, i18n);
      }
    }, _callee, null, [[1, 3]]);
  }));
  return function loadI18n() {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n/* ================== ROOT STYLES ================== */\n.customer-display-container[data-v-1470f910] {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n  background: linear-gradient(135deg, #1e3a8a 0%, #0f172a 100%);\n  color: #ffffff;\n  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n  overflow: hidden;\n}\n.customer-display-container.light[data-v-1470f910] {\n  background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%);\n  color: #1e293b;\n}\n\n/* ================== HEADER ================== */\n.cd-header[data-v-1470f910] {\n  background: linear-gradient(135deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0) 100%);\n  padding: 30px 40px;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.1);\n  display: flex;\n  align-items: center;\n  gap: 30px;\n  backdrop-filter: blur(10px);\n}\n.light .cd-header[data-v-1470f910] {\n  border-bottom-color: rgba(15, 23, 42, 0.1);\n  background: linear-gradient(135deg, rgba(15, 23, 42, 0.02) 0%, rgba(15, 23, 42, 0) 100%);\n}\n.logo-wrapper[data-v-1470f910] {\n  flex-shrink: 0;\n}\n.store-logo[data-v-1470f910] {\n  height: 60px;\n  width: auto;\n  border-radius: 12px;\n  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.3);\n  animation: slideInLeft-1470f910 0.6s cubic-bezier(0.34, 1.56, 0.64, 1);\n}\n.light .store-logo[data-v-1470f910] {\n  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.1);\n}\n.store-info[data-v-1470f910] {\n  flex: 1;\n}\n.payable-summary[data-v-1470f910] {\n  margin-left: auto;\n  text-align: right;\n}\n.payable-label[data-v-1470f910] {\n  font-size: 12px;\n  letter-spacing: .5px;\n  opacity: .8;\n}\n.payable-value[data-v-1470f910] {\n  font-size: 28px;\n  font-weight: 800;\n  background: linear-gradient(135deg, #fbbf24, #f97316);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  background-clip: text;\n}\n.light .payable-value[data-v-1470f910] {\n  background: linear-gradient(135deg, #f59e0b, #f97316);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  background-clip: text;\n}\n.store-name[data-v-1470f910] {\n  font-size: 32px;\n  font-weight: 700;\n  margin: 0;\n  letter-spacing: -1px;\n  animation: slideInDown-1470f910 0.6s cubic-bezier(0.34, 1.56, 0.64, 1);\n}\n.tagline[data-v-1470f910] {\n  font-size: 14px;\n  margin: 8px 0 0 0;\n  opacity: 0.7;\n  animation: fadeIn-1470f910 0.8s ease-out 0.2s both;\n}\n\n/* ================== CONTENT AREA ================== */\n.cd-content[data-v-1470f910] {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  padding: 40px;\n  overflow: hidden;\n}\n.cd-scroll[data-v-1470f910] {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  scrollbar-width: thin;\n  scrollbar-color: rgba(255, 255, 255, 0.2) transparent;\n}\n.cd-scroll[data-v-1470f910]::-webkit-scrollbar {\n  width: 6px;\n}\n.cd-scroll[data-v-1470f910]::-webkit-scrollbar-track {\n  background: transparent;\n}\n.cd-scroll[data-v-1470f910]::-webkit-scrollbar-thumb {\n  background: rgba(255, 255, 255, 0.2);\n  border-radius: 3px;\n}\n.cd-scroll[data-v-1470f910]::-webkit-scrollbar-thumb:hover {\n  background: rgba(255, 255, 255, 0.3);\n}\n\n/* ================== EMPTY STATE ================== */\n.empty-state[data-v-1470f910] {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 60px 20px;\n  text-align: center;\n}\n.empty-icon[data-v-1470f910] {\n  font-size: 80px;\n  margin-bottom: 24px;\n  opacity: 0.4;\n  animation: float-1470f910 3s ease-in-out infinite;\n}\n.empty-title[data-v-1470f910] {\n  font-size: 28px;\n  font-weight: 600;\n  margin: 0 0 12px 0;\n  opacity: 0.9;\n}\n.empty-subtitle[data-v-1470f910] {\n  font-size: 16px;\n  margin: 0;\n  opacity: 0.6;\n}\n.light .empty-title[data-v-1470f910],\n.light .empty-subtitle[data-v-1470f910] {\n  color: #475569;\n}\n\n/* ================== ITEMS LIST ================== */\n.cd-list[data-v-1470f910] {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n  margin-bottom: 24px;\n}\n.cd-item[data-v-1470f910] {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  padding: 18px 24px;\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(139, 92, 246, 0.05) 100%);\n  border: 1px solid rgba(59, 130, 246, 0.2);\n  border-radius: 14px;\n  backdrop-filter: blur(10px);\n  transition: all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1);\n  animation: slideInRight-1470f910 0.5s ease-out;\n}\n.cd-item[data-v-1470f910]:hover {\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.15) 0%, rgba(139, 92, 246, 0.1) 100%);\n  border-color: rgba(59, 130, 246, 0.3);\n  transform: translateX(8px);\n}\n.light .cd-item[data-v-1470f910] {\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.05) 0%, rgba(139, 92, 246, 0.02) 100%);\n  border-color: rgba(59, 130, 246, 0.15);\n}\n.light .cd-item[data-v-1470f910]:hover {\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.08) 0%, rgba(139, 92, 246, 0.05) 100%);\n  border-color: rgba(59, 130, 246, 0.25);\n}\n.item-left[data-v-1470f910] {\n  display: flex;\n  align-items: flex-start;\n  gap: 16px;\n  flex: 1;\n}\n.item-icon[data-v-1470f910] {\n  flex-shrink: 0;\n  width: 48px;\n  height: 48px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.2) 0%, rgba(139, 92, 246, 0.1) 100%);\n  border-radius: 10px;\n  color: #60a5fa;\n}\n.light .item-icon[data-v-1470f910] {\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(139, 92, 246, 0.05) 100%);\n  color: #3b82f6;\n}\n.item-info[data-v-1470f910] {\n  flex: 1;\n  min-width: 0;\n}\n.item-name[data-v-1470f910] {\n  font-size: 18px;\n  font-weight: 600;\n  margin: 0 0 6px 0;\n  word-break: break-word;\n  color: #ffffff;\n}\n.light .item-name[data-v-1470f910] {\n  color: #1e293b;\n}\n.item-qty[data-v-1470f910] {\n  font-size: 13px;\n  opacity: 0.7;\n  color: #cbd5e1;\n}\n.light .item-qty[data-v-1470f910] {\n  color: #64748b;\n}\n.item-qty strong[data-v-1470f910] {\n  font-weight: 600;\n  opacity: 1;\n  font-size: 14px;\n}\n.item-price[data-v-1470f910] {\n  text-align: right;\n  flex-shrink: 0;\n}\n.price-value[data-v-1470f910] {\n  font-size: 22px;\n  font-weight: 700;\n  background: linear-gradient(135deg, #60a5fa, #a78bfa);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  background-clip: text;\n}\n.light .price-value[data-v-1470f910] {\n  background: linear-gradient(135deg, #3b82f6, #8b5cf6);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  background-clip: text;\n}\n\n/* ================== SUMMARY SECTION ================== */\n.cd-summary[data-v-1470f910] {\n  padding-top: 24px;\n}\n.summary-card[data-v-1470f910] {\n  padding: 28px;\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.15) 0%, rgba(139, 92, 246, 0.1) 100%);\n  border: 2px solid rgba(59, 130, 246, 0.3);\n  border-radius: 18px;\n  backdrop-filter: blur(20px);\n  box-shadow: 0 8px 32px rgba(59, 130, 246, 0.1);\n}\n.light .summary-card[data-v-1470f910] {\n  background: linear-gradient(135deg, rgba(59, 130, 246, 0.08) 0%, rgba(139, 92, 246, 0.04) 100%);\n  border-color: rgba(59, 130, 246, 0.2);\n  box-shadow: 0 8px 32px rgba(59, 130, 246, 0.05);\n}\n.summary-row[data-v-1470f910] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n  font-size: 16px;\n}\n.summary-row[data-v-1470f910]:last-of-type {\n  margin-bottom: 0;\n}\n.summary-label[data-v-1470f910] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  font-weight: 500;\n  opacity: 0.8;\n  font-size: 15px;\n}\n.summary-value[data-v-1470f910] {\n  font-weight: 600;\n  color: #60a5fa;\n  font-size: 16px;\n}\n.light .summary-value[data-v-1470f910] {\n  color: #3b82f6;\n}\n.summary-value.discount[data-v-1470f910] {\n  color: #34d399;\n}\n.light .summary-value.discount[data-v-1470f910] {\n  color: #10b981;\n}\n.divider[data-v-1470f910] {\n  height: 1px;\n  background: rgba(255, 255, 255, 0.1);\n  margin: 16px 0;\n}\n.light .divider[data-v-1470f910] {\n  background: rgba(15, 23, 42, 0.1);\n}\n.total-row[data-v-1470f910] {\n  margin-bottom: 0;\n  font-size: 18px;\n}\n.total-label[data-v-1470f910] {\n  font-weight: 700;\n  opacity: 1;\n  font-size: 16px;\n}\n.total-value[data-v-1470f910] {\n  font-size: 28px;\n  font-weight: 800;\n  background: linear-gradient(135deg, #fbbf24, #f97316);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  background-clip: text;\n}\n.light .total-value[data-v-1470f910] {\n  background: linear-gradient(135deg, #f59e0b, #f97316);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  background-clip: text;\n}\n\n/* ================== FOOTER ================== */\n.cd-footer[data-v-1470f910] {\n  padding: 24px 40px;\n  border-top: 1px solid rgba(255, 255, 255, 0.1);\n  background: linear-gradient(135deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.05) 100%);\n  text-align: center;\n  backdrop-filter: blur(10px);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 12px;\n}\n.light .cd-footer[data-v-1470f910] {\n  border-top-color: rgba(15, 23, 42, 0.1);\n  background: linear-gradient(135deg, rgba(15, 23, 42, 0.02) 0%, rgba(15, 23, 42, 0) 100%);\n}\n.footer-message[data-v-1470f910] {\n  font-size: 16px;\n  font-weight: 500;\n  margin: 0;\n  opacity: 0.9;\n  animation: fadeIn-1470f910 0.8s ease-out;\n}\n.light .footer-message[data-v-1470f910] {\n  color: #334155;\n}\n.progress-indicator[data-v-1470f910] {\n  display: flex;\n  gap: 8px;\n  justify-content: center;\n}\n.progress-dot[data-v-1470f910] {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background: rgba(255, 255, 255, 0.4);\n  animation: pulse-1470f910 2s ease-in-out infinite;\n}\n.light .progress-dot[data-v-1470f910] {\n  background: rgba(15, 23, 42, 0.4);\n}\n\n/* ================== ANIMATIONS ================== */\n@keyframes slideInLeft-1470f910 {\nfrom {\n    opacity: 0;\n    transform: translateX(-30px);\n}\nto {\n    opacity: 1;\n    transform: translateX(0);\n}\n}\n@keyframes slideInDown-1470f910 {\nfrom {\n    opacity: 0;\n    transform: translateY(-20px);\n}\nto {\n    opacity: 1;\n    transform: translateY(0);\n}\n}\n@keyframes slideInRight-1470f910 {\nfrom {\n    opacity: 0;\n    transform: translateX(-20px);\n}\nto {\n    opacity: 1;\n    transform: translateX(0);\n}\n}\n@keyframes fadeIn-1470f910 {\nfrom {\n    opacity: 0;\n}\nto {\n    opacity: 1;\n}\n}\n@keyframes float-1470f910 {\n0%, 100% {\n    transform: translateY(0);\n}\n50% {\n    transform: translateY(-20px);\n}\n}\n@keyframes pulse-1470f910 {\n0%, 100% {\n    opacity: 0.4;\n    transform: scale(1);\n}\n50% {\n    opacity: 1;\n    transform: scale(1.2);\n}\n}\n\n/* ================== RESPONSIVE DESIGN ================== */\n@media (max-width: 768px) {\n.cd-header[data-v-1470f910] {\n    padding: 20px;\n    gap: 16px;\n    flex-direction: column;\n    text-align: center;\n}\n.store-logo[data-v-1470f910] {\n    height: 48px;\n}\n.store-name[data-v-1470f910] {\n    font-size: 24px;\n}\n.tagline[data-v-1470f910] {\n    font-size: 13px;\n}\n.payable-summary[data-v-1470f910] {\n    margin-left: 0;\n    text-align: center;\n}\n.payable-value[data-v-1470f910] {\n    font-size: 24px;\n}\n.cd-content[data-v-1470f910] {\n    padding: 20px;\n}\n.cd-item[data-v-1470f910] {\n    padding: 14px 16px;\n    flex-direction: column;\n}\n.item-price[data-v-1470f910] {\n    text-align: left;\n    margin-top: 12px;\n}\n.price-value[data-v-1470f910] {\n    font-size: 18px;\n}\n.summary-card[data-v-1470f910] {\n    padding: 20px;\n}\n.cd-footer[data-v-1470f910] {\n    padding: 16px 20px;\n}\n.summary-label[data-v-1470f910],\n  .summary-value[data-v-1470f910] {\n    font-size: 14px;\n}\n.total-value[data-v-1470f910] {\n    font-size: 24px;\n}\n}\n@media (max-width: 480px) {\n.store-name[data-v-1470f910] {\n    font-size: 20px;\n}\n.cd-content[data-v-1470f910] {\n    padding: 16px;\n}\n.cd-item[data-v-1470f910] {\n    padding: 12px;\n}\n.item-icon[data-v-1470f910] {\n    width: 40px;\n    height: 40px;\n}\n.item-name[data-v-1470f910] {\n    font-size: 16px;\n}\n.summary-card[data-v-1470f910] {\n    padding: 16px;\n}\n.cd-footer[data-v-1470f910] {\n    padding: 12px 16px;\n    font-size: 14px;\n}\n}\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_style_index_0_id_1470f910_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_style_index_0_id_1470f910_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/src/views/app/pages/customer/CustomerDisplay.vue"
/*!********************************************************************!*\
  !*** ./resources/src/views/app/pages/customer/CustomerDisplay.vue ***!
  \********************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CustomerDisplay_vue_vue_type_template_id_1470f910_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true */ "./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true");
/* harmony import */ var _CustomerDisplay_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CustomerDisplay.vue?vue&type=script&lang=js */ "./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=script&lang=js");
/* harmony import */ var _CustomerDisplay_vue_vue_type_style_index_0_id_1470f910_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css */ "./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _CustomerDisplay_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _CustomerDisplay_vue_vue_type_template_id_1470f910_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _CustomerDisplay_vue_vue_type_template_id_1470f910_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "1470f910",
  null
...
{ var api; }
component.options.__file = "resources/src/views/app/pages/customer/CustomerDisplay.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ },

/***/ "./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=script&lang=js"
/*!********************************************************************************************!*\
  !*** ./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=script&lang=js ***!
  \********************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomerDisplay.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ },

/***/ "./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true"
/*!**************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true ***!
  \**************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_template_id_1470f910_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_template_id_1470f910_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_template_id_1470f910_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=template&id=1470f910&scoped=true");


/***/ },

/***/ "./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css"
/*!****************************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css ***!
  \****************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplay_vue_vue_type_style_index_0_id_1470f910_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplay.vue?vue&type=style&index=0&id=1470f910&scoped=true&lang=css");
...
"use strict";
/*!*******************************************!*\
  !*** ./resources/src/customer-display.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.esm.js");
/* harmony import */ var _views_app_pages_customer_CustomerDisplay_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/app/pages/customer/CustomerDisplay.vue */ "./resources/src/views/app/pages/customer/CustomerDisplay.vue");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! axios */ "./node_modules/axios/lib/axios.js");
...
/* harmony import */ var _plugins_i18n_loader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./plugins/i18n.loader */ "./resources/src/plugins/i18n.loader.js");
...
window.CD = new vue__WEBPACK_IMPORTED_MODULE_0__["default"]();
(0,_plugins_i18n_loader__WEBPACK_IMPORTED_MODULE_4__.loadI18n)().then(function (i18n) {
  new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
    i18n: i18n,
    render: function render(h) {
      return h(_views_app_pages_customer_CustomerDisplay_vue__WEBPACK_IMPORTED_MODULE_1__["default"]);
    }
