        ...
        <b-form @submit.prevent="Submit_Shipment">
          ...
          <b-row v-else>
            ...
            <b-col md="12">
              <div class="shipment-credit-summary mb-3">
                ...
                <div>
                  ...
                  <strong>{{ shipmentShippedCount }} shipped / {{ shipmentTotalCount }} items</strong>
                </div>
                <div>
                  <small>Sale Balance</small>
                  <strong :class="shipmentSaleBalance > 0 ? 'text-danger' : 'text-success'">{{ shipmentMoney(shipmentSaleBalance) }}</strong>
                </div>
                <div>
            ...
            <b-col md="12">
              <div class="shipment-section mb-3">
                ...
                <table class="table table-hover mb-0">
                  ...
                  <tbody>
                    <tr
                      v-for="item in remainingShipmentItems"
                      :key="item.sale_detail_id"
                      :class="{'shipment-item-eligible': item.eligible && !item.is_shipped, 'shipment-item-disabled': shipmentItemDisabled(item)}"
                    >
                      ...
                      <td class="align-middle shipment-eligibility-cell">
                        <b-badge :variant="shipmentItemBadgeVariant(item)">
                    ...
                    <tr v-if="!remainingShipmentItems.length">
                      <td colspan="8" class="text-center text-muted py-4">All sale items have already been delivered.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
            ...
            <b-col md="12" class="mt-3">
              ...
              <small v-if="!selectedShipmentItemIds.length && remainingShipmentItems.length" class="text-muted ml-2">
