          ...
          >
            ...
            <div class="dz-inner text-center">
              ...
              <div class="text-muted small">
                Allowed formats: XLSX, XLS Â· Max size: 20MB
              </div>
          ...
          <div class="d-flex flex-wrap align-items-center mt-3">
            ...
            >
              ...
              <span v-else class="d-inline-flex align-items-center">
                <span class="spinner sm spinner-white mr-2"></span>Processingâ€¦
              </span>
            </b-button>
        ...
        <b-col md="12" class="mb-4">
          <b-card class="mb-3">
            ...
            <div v-else>
              ...
              <ul class="mini-notes mt-3">
                <li><strong>product_code</strong> â€” Parent product code used to group variants.</li>
                <li><strong>variant_code</strong> â€” Variant code must be globally unique.</li>
                <li><strong>unit</strong> â€” Unit must already exist Â· Use the unit short name when possible.</li>
                <li><strong>category</strong> â€” Will be created if missing.</li>
                <li><strong>sub_category</strong> â€” Optional. Will be created under its category if it doesn't exist.</li>
  ...
  data() {
    return {
      ...
      singlesGuide: [
        ...
        { key: 'Retail price',label: 'Retail price',   required: false },
...
/* Example table â€” keep the green "required" cells (saturated text on
...
/* Chip grid (column guide) â€” chip-opt was light-gray-on-light-gray
