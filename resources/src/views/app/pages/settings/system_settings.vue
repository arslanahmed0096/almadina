...
{{$t('submit')}}
                  ...
                  <div v-show="activeTab === 'prefixes'" class="tab-content">
                    <b-row>
                      ...
                      <!-- Product Prefix -->
                      <b-col lg="6" md="6" sm="12" class="mb-3">
                        <b-form-group label="Product Prefix">
                          <b-form-input
                            v-model="setting.product_prefix"
                            placeholder="AME"
                            maxlength="10"
                          ></b-form-input>
                          <small class="text-muted">Example: AME (new product codes will generate like AME0001)</small>
                        </b-form-group>
                      </b-col>
                    </b-row>
                    ...
                    <b-row>
                      <b-col lg="12" class="mb-3">
                        <div class="alert alert-info">
                          <strong>Note:</strong> If a prefix is empty, the system will use the default prefix (SL for sales, PR for purchases, QT for quotations, AD for adjustments, TR for transfers, RT for returns, AME for products). 
...
export default {
  ...
  methods: {
    ...
    Update_Settings() {
      ...
      self.data.append("product_prefix", self.setting.product_prefix || 'AME');
