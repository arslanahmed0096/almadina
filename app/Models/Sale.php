...
class Sale extends Model
{
    ...
    protected $fillable = [
        ...
        'paid_amount', 'payment_statut', 'credit_days', 'credit_due_date', 'created_at', 'updated_at', 'deleted_at', 'shipping_status', 'subscription_id', 'sales_agent_id',
